...
<div class="bread">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Manufacturers & Suppliers Directory</li>
        </ol>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-8 header-banner-lg">
                <div class="header-ban-content">
                    <h1>
                        <span>Find Manufacturers and Suppliers</span> Around the World <br>and Grow Your Business
                    </h1>
                    <p>Post You Buying Requirements <br>and Get the Relevant <br>Suppliers</p>
                </div>
            </div>
