  ...
  <div class="row ">
    <div class="col-md-6 m-auto">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{url('b2b/tradeShow/add')}}" method="POST" enctype="multipart/form-data">@csrf
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8 my-5">
                <div class="form-group">
                  ...
                  <textarea  id="editor" name="ev_description" class="form-control" placeholder="Make event description"></textarea>
                </div>
              </div>
              <div class="col-md-8">
                <div class="form-group" >
                  <label class="bmd-label-floating">Organization Profile</label>
                  <input type="text" name="org_profile" class="form-control" required>
                </div>
              </div>
            </div>
