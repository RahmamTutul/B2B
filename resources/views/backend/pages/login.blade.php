...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="collapse navbar-collapse justify-content-center">
        <h3 class="nav-link" style="text-transform: uppercase">
            <i class="material-icons">lock_open</i>
            You are entering a protected area! Please enter credentials.
        </h3>
      </div>
    </div>
  </nav>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('https://industrytoday.com/wp-content/uploads/2017/08/Going-Digital.jpg'); background-size: cover; background-position: top center;">
      <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="post" action="{{url('b2b/admin_login')}}">@csrf
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  <button type="submit" href="#pablo" class="btn btn-rose btn-link btn-lg">Enter</button>
                </div>
              </div>
            </form>
          </div>
